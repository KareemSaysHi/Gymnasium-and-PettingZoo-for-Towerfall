...
This project builds upon Vini Ruela's [TowerFall-AI](https://github.com/TowerfallAi/towerfall-ai), which allows a Python script to interact with a TowerFall instance.  Both PettingZoo and Gymnasium environments have been made for TowerFall, and this repository has examples for training with both environments.  
