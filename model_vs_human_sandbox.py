...
from agents import PPOAgentShooting_V0, SimpleAgent
...
def main():
  ...
  for i in range(remote_agents):
    ...
    agents.append(PPOAgentShooting_V0(
      connection = connections[i],
      mode = "evaluating",
      model = model,
      normalizer = normalizer,
      frames_per_action = 5))
    #agents.append(SimpleAgent(connection=connections[i], attack_archers=True))
