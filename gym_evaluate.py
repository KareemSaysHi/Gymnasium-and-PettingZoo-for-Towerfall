...
# a modified version of evaluate_saved_model.py, but keeping both for later reference
...
ax.set_ylabel("Performance over 100 Games against SmarterBaselineAgent")
