...
class DummyAgentShooting:
  ...
  def update_data(self, game_state: Mapping[str, Any]):
    '''
    Refreshes archer data (pos, vel, dead, arrows) from an update
    '''
    ...
    for e in game_state['entities']:
      if e['type'] == 'archer' and e['playerIndex'] == self.state_init['index']:
        ...
        self.my_facing = (e['facing']+ 1) // 2 #convert -1/1 to 0/1
        self.dead = False  # Archer wasn't in the entity list — treat as not dead.
